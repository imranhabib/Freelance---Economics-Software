...
public class phase3 extends JFrame{
  ...
  public phase3 (final List<List<Share>> stage2ShareList, final int m, final double r, final double[] incomeShares) {
    ...
    buttonFirst.setBorder(new TitledBorder("Current Choice Rule Allocation vs. Choice Rule applied to Stage 1 Pricing"));
    buttonSecond.setBorder(new TitledBorder("Current Choice Rule Allocation vs. Choice Rule applied to Stage 1 Pricing"));
    buttonThird.setBorder(new TitledBorder("Current Choice Rule Allocation vs. Choice Rule applied to Stage 1 Pricing"));
    button4.setBorder(new TitledBorder("Current Choice Rule Allocation vs. Choice Rule applied to Stage 1 Pricing"));
    button5.setBorder(new TitledBorder("Current Choice Rule Allocation vs. Choice Rule applied to Stage 1 Pricing"));
    button6.setBorder(new TitledBorder("Current Choice Rule Allocation vs. Choice Rule applied to Stage 1 Pricing"));
    button7.setBorder(new TitledBorder("Current Choice Rule Allocation vs. Choice Rule applied to Stage 1 Pricing"));
    button8.setBorder(new TitledBorder("Current Choice Rule Allocation vs. Choice Rule applied to Stage 1 Pricing"));
    ...
    button15.setBorder(new TitledBorder("Stage 1 Allocations"));
    ...
    applyChoiceButton = new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        int result = JOptionPane.showConfirmDialog(null,
            "Are you sure you want to stage 1 prices to choice rule?", "Confirmation", JOptionPane.YES_NO_OPTION);
    ...
    continueButton = new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if(maintain){
          ...
          phase1.add(shareList10);
          closeFile(reader10);



          phase4 phasez = new phase4(stage2ShareList, M, R, phase1);
        ...
        if(apply){
          ...
          phase4 phasez = new phase4(stage2ShareList, M, R, listOfAllocs);
          phasez.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
          phasez.setVisible(true);
