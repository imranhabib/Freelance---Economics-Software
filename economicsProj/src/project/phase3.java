...
//    final String adminDirectory = System.getProperty("user.home")+ "/Desktop";
        ...
        buttonFirst = new JButton("Select to view allocations (Round 1)");
        buttonSecond  = new JButton("Select to view allocations (Round 2)");
        buttonThird = new JButton("Select to view allocations (Round 3)");
        button4 = new JButton("Select to view allocations (Round 4)");
        button5 = new JButton("Select to view allocations (Round 5)");
        button6 = new JButton("Select to view allocations (Round 6)");
        button7 = new JButton("Select to view allocations (Round 7)");
        button8 = new JButton("Select to view allocations (Round 8)");
        button9 = new JButton("Select to view allocations (Round 9)");
        button10 = new JButton("Select to view allocations (Round 10)");
...
//new code
        ...
        String[] secondLine10 = line10.split("@");
        ...
        inputButton = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                double temp = r;
                String data = Double.toString(temp);
                ...
                JLabel minshare = new JLabel("Minimum tokens in each account: " + Integer.toString(m));
                JLabel ratio = new JLabel("M-ratio: " + data);
                String iS = "";
...
//one side is going to be stage2shareList.get(x) This will be the left side, right side is going to be stage2ShareListWithSwitch
        ...
        applyChoiceButton = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int result = JOptionPane.showConfirmDialog(null,
                        "Are you sure you want to apply the choice rule to stage 1 prices? This will cost you 1 token.", "Confirmation", JOptionPane.YES_NO_OPTION);
        ...
        continueButton = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(apply){
                    ...
                    instrucs.dispose();
                    instructions4 inst = new instructions4();
    ...
    public void allocationPage(final List<List<Share>> stage1whole, final List<Share> stage1, final List<List<Share>> stage2whole, final List<Share> stage2, final double r, final int m, final int count){
        ...
        for (int i = 0; i < stage1.size(); i++) {
            ...
            int prix = stage1.get(i).getPrice();
            double prixd = prix;
            prixd = prixd /100;
            ...
            panels.setBorder(new TitledBorder("Account " + stage1.get(i).getSecurityNumber()));
        ...
        for(int i = 0; i <stage2.size(); i++){
            ...
            panels.add(progress);
            panels.add(jText);
            panels.setBorder(new TitledBorder("Account " + stage2.get(i).getSecurityNumber()));
...
//        }
    ...
    public ArrayList<Share> convertPriceSets(String[] prices, double r, int minShare, double[] incomes, int max){
        ...
        for(int i=0; i< prices.length; i++){
            ...
            System.out.println("NEW PRICES " + temp);
    ...
    public Double allocationMethodThree(int shareNumber, List<Share> shares, int x, int maxMoney, double meanPrice, double mbar) {
        ...
        int pI = shares.get(shareNumber - 1).getPrice() /10;
