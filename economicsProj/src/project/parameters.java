...
public class parameters {
  ...
  public ArrayList<Integer> getSecurityPriceListStage2Test(){
    testClass test = new testClass();
    String price = bundle.getString("securityPriceListStage2Test" + test.getCurrent());
    String[] priceList = price.split(",");
    ArrayList<Integer> prices = new ArrayList<Integer>();
    for(String str: priceList){
      prices.add(Integer.parseInt(str));
  ...
  public ArrayList<Integer> getSecurityPriceListStage1TestRounds(){
    testClass test = new testClass();
    String price = bundle.getString("securityPriceListTest" + test.getCurrent());
    String[] priceList = price.split(",");
    ArrayList<Integer> prices = new ArrayList<Integer>();
    for(String str: priceList){
      prices.add(Integer.parseInt(str));
  ...
  public List<Share> getSecurityListWithEmptyIncomeSharesStage2test(){
    testClass test = new testClass();
    ArrayList<Share> shares = new ArrayList<Share>();
    String security = bundle.getString("securityList" + test.getCurrent());
    String[] securityNumber = security.split(",");
    ArrayList<Integer> securityPrices = getSecurityPriceListStage2Test();
    //get income share
    //  ArrayList<Float> incomeShareList = getIncomeShareList();
    for (int i=1; i < securityNumber.length+1; i++) {
      Double is = 0.0;
  ...
  public List<Share> getSecurityListWithEmptyIncomeSharesStage2Prices(){
    ...
    String[] securityNumber = security.split(",");
    ArrayList<Integer> securityPrices = getSecurityPriceListStage2();
    //get income share
    //  ArrayList<Float> incomeShareList = getIncomeShareList();
    for (int i=1; i < securityNumber.length+1; i++) {
      Double is = 0.0;
  ...
  public List<Share> getSecurityListWithEmptyIncomeSharesStage1TestRoundPrices(){
    testClass test = new testClass();
    ArrayList<Share> shares = new ArrayList<Share>();
    String security = bundle.getString("securityListTest" + test.getCurrent());
    String[] securityNumber = security.split(",");
    ArrayList<Integer> securityPrices = getSecurityPriceListStage1TestRounds();
  ...
  public double getMeanPriceAmount(String priceSet){
    testClass test = new testClass();
    String price = bundle.getString(priceSet + test.getCurrent());
    String[] priceList = price.split(",");
    ...
    for(String str: priceList){
      ...
      System.out.println("here are prices doe " + str);
    }
    double sum = 0;
    ...
    System.out.println("sum " + (sum/amount)/100);
